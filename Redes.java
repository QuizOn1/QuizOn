...
public class Redes extends AppCompatActivity {
    ...
    private List<String> codeFragments; // Lista para almacenar los fragmentos de código
    private List<String> correctOrder; // Lista para almacenar el orden correcto de los fragmentos

    private TextView draggableItem;
    private RelativeLayout dropTarget;
